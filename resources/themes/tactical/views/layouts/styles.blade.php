...
<link rel="stylesheet" href="{{ asset('tactical/assets/css/style.css') }}">
<link rel="stylesheet" href="{{ asset('tactical/assets/css/demo7.min.css') }}">
<link rel="stylesheet" href="{{ asset('tactical/assets/css/demo7.custom.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('tactical/assets/vendor/fontawesome-free/css/all.min.css') }}">
