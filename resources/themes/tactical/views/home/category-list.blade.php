...
@section('full-content-wrapper')
    ...
    <div class="category-banner-container bg-gray">
        <div class="category-banner banner text-uppercase"
            style="background: no-repeat 60%/cover url({{ asset('tactical/assets/images/banners/banner-top.jpg') }});">
            ...
            <div class="col-lg-9 order-lg-1">
                <nav class="toolbox sticky-header" data-sticky-options="{'mobile': true}">
                    ...
                    <div class="toolbox-right">
                        ...
                        <div class="toolbox-item layout-modes">
                            <a href="{{ route('shop.home.category') }}" class="layout-btn btn-grid" title="Grid">
                                <i class="icon-mode-grid"></i>
                            </a>
                            <a href="{{ route('shop.home.categorylist') }}" class="layout-btn btn-list active" title="List">
                ...
                <div class="row pb-4">
                    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                        <figure>
                            <a href="product.html">
                                <img src="{{ asset('tactical/assets/images/products/product-1.jpg') }}" width="250" height="250"
                                    alt="product" />
                                <img src="{{ asset('tactical/assets/images/products/product-1-2.jpg') }}" width="250" height="250"
                                    alt="product" />
                            </a>
                        </figure>
                    ...
                    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                        <figure>
                            <a href="product.html">
                                <img src="{{ asset('tactical/assets/images/products/product-2.jpg') }}" width="250" height="250"
                                    alt="product" />
                                <img src="{{ asset('tactical/assets/images/products/product-2-2.jpg') }}" width="250" height="250"
                                    alt="product" />
                            </a>
                        </figure>
                    ...
                    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                        <figure>
                            <a href="product.html">
                                <img src="{{ asset('tactical/assets/images/products/product-3.jpg') }}" width="250" height="250"
                                    alt="product" />
                                <img src="{{ asset('tactical/assets/images/products/product-3-2.jpg') }}" width="250" height="250"
                                    alt="product" />
                            </a>
                        </figure>
                    ...
                    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                        <figure>
                            <a href="product.html">
                                <img src="{{ asset('tactical/assets/images/products/product-4.jpg') }}" width="250" height="250"
                                    alt="product" />
                                <img src="{{ asset('tactical/assets/images/products/product-4-2.jpg') }}" width="250" height="250"
                                    alt="product">
                            </a>
                        </figure>
                    ...
                    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                        <figure>
                            <a href="product.html">
                                <img src="{{ asset('tactical/assets/images/products/product-5.jpg') }}" width="250" height="250"
                                    alt="product" />
                                <img src="{{ asset('tactical/assets/images/products/product-5-2.jpg') }}" width="250" height="250"
                                    alt="product" />
                            </a>
                        </figure>
                    ...
                    <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                        <figure>
                            <a href="product.html">
                                <img src="{{ asset('tactical/assets/images/products/product-6.jpg') }}" width="250" height="250"
                                    alt="product">
                                <img src="{{ asset('tactical/assets/images/products/product-6-2.jpg') }}" width="250" height="250"
                                    alt="product" />
                            </a>
                        </figure>
                            ...
                            <div class="owl-carousel widget-featured-products">
                                <div class="featured-col">
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('tactical/assets/images/products/small/product-4.jpg') }}" width="75"
                                                    height="75" alt="product" />
                                                <img src="{{ asset('tactical/assets/images/products/small/product-4-2.jpg') }}"
                                    ...
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('tactical/assets/images/products/small/product-5.jpg') }}" width="75"
                                                    height="75" alt="product" />
                                                <img src="{{ asset('tactical/assets/images/products/small/product-5-2.jpg') }}"
                                                    width="75" height="75" alt="product" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('tactical/assets/images/products/small/product-6.jpg') }}" width="75"
                                                    height="75" alt="product" />
                                                <img src="{{ asset('tactical/assets/images/products/small/product-6-2.jpg') }}"
                                                    width="75" height="75" alt="product" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                ...
                                <div class="featured-col">
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('tactical/assets/images/products/small/product-1.jpg') }}" width="75"
                                                    height="75" alt="product" />
                                                <img src="{{ asset('tactical/assets/images/products/small/product-1-2.jpg') }}"
                                                    width="75" height="75" alt="product" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('tactical/assets/images/products/small/product-2.jpg') }}" width="75"
                                                    height="75" alt="product" />
                                                <img src="{{ asset('tactical/assets/images/products/small/product-2-2.jpg') }}"
                                                    width="75" height="75" alt="product" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
                                    ...
                                    <div class="product-default left-details product-widget">
                                        <figure>
                                            <a href="product.html">
                                                <img src="{{ asset('tactical/assets/images/products/small/product-3.jpg') }}" width="75"
                                                    height="75" alt="product" />
                                                <img src="{{ asset('tactical/assets/images/products/small/product-3-2.jpg') }}"
                                                    width="75" height="75" alt="product" />
                                            </a>
                                        </figure>
                                        <div class="product-details">
